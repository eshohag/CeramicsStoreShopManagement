                ...
                c => new
                    {
                        ...
                        Title = c.String(),
                        ProductViewModel_ProductViewModelID = c.Int(),
                    })
                .PrimaryKey(t => t.BrandID)
                .ForeignKey("dbo.ProductViewModels", t => t.ProductViewModel_ProductViewModelID)
                .Index(t => t.ProductViewModel_ProductViewModelID);
